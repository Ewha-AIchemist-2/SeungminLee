...
def exec_kfold(clf, folds = 5) :
    # 폴드 세트rk 5개인 KFold 객체 생성. 폴드 수만큼 예측결과 저장 위한 리스트 생성
...
from sklearn.model_selection import class_val_score

scores = cross_val_score(df_clf, X_titanic_dif, y_titanic_df, cv=5)
